                    ...
                    <div>
                            <div class="col-lg-6">
                                ...
                                <div class="top-campaign">
                                    <h3 class="title-3 m-b-30">Covid-19 Data / Age</h3>
...
<?php
    ...
    $i=1;
    $age = mysqli_query($kon, "SELECT DISTINCT tanggal_lahir FROM pasien");
    while($dataAge = mysqli_fetch_assoc($age)){
        $count = mysqli_query($kon, "SELECT COUNT(id_pasien) as temp FROM pasien WHERE tanggal_lahir='".$dataAge['tanggal_lahir']."' AND id_pasien IN (SELECT id_pasien FROM pemeriksaan WHERE hasil='Positive')");
        while($dataCount = mysqli_fetch_assoc($count)){
            echo "<tr>";
            echo "<td>".$i++."</td>";
            echo "<td>".$dataAge['tanggal_lahir']."</td>";
