                    ...
                    <div>
                            <div class="col-lg-6">
                                ...
                                <div class="top-campaign">
                                    <h3 class="title-3 m-b-30">Doctor</h3>
                                    <div class="table-responsive">
                                        <?php
                                            include 'connection.php';
                                        $count = mysqli_query($kon, "SELECT COUNT(id_dokter) FROM dokter WHERE id_dokter IN (SELECT id_dokter FROM pemeriksaan WHERE hasil='Positive')");
                                        while($dataCount = mysqli_fetch_assoc($count)){
                                            $n = $dataCount['COUNT(id_dokter)'];    
                                        }
                                            ?>
                                        <h4 class="title-3 m-b-30">Total Doctor Handling Covid-19 : <?php echo "<b>".$n."</b>";?></h4>
...
<?php
    ...
    while($dataDokter = mysqli_fetch_assoc($dokter)){
        $count = mysqli_query($kon, "SELECT COUNT(id_dokter) as temp FROM pemeriksaan WHERE id_dokter='".$dataDokter['id_dokter']."' AND hasil='Positive'");
        while($dataCount = mysqli_fetch_assoc($count)){
            echo "<tr>";
            echo "<td>".$i++."</td>";
