                    ...
                    <div>
                            <div class="col-lg-6">
                                ...
                                <div class="top-campaign">
                                    <h3 class="title-3 m-b-30">Hospital</h3>
                                    <div class="table-responsive">
                                        <?php
                                            include 'connection.php';
                                        $count = mysqli_query($kon, "SELECT COUNT(id_rs) FROM rs WHERE id_rs IN (SELECT id_rs FROM pemeriksaan WHERE hasil='Positive')");
                                        while($dataCount = mysqli_fetch_assoc($count)){
                                            $n = $dataCount['COUNT(id_rs)'];    
                                        }
                                            ?>
                                        <h4 class="title-3 m-b-30">Total Hospital Handling Covid-19 : <?php echo "<b>".$n."</b>";?></h4>
...
<?php
    ...
    $i=1;
    $hospital = mysqli_query($kon, "SELECT * FROM rs");
    while($dataHospital = mysqli_fetch_assoc($hospital)){
        $count = mysqli_query($kon, "SELECT COUNT(id_rs) as temp FROM pemeriksaan WHERE id_rs='".$dataHospital['id_rs']."' AND hasil='Positive'");
        while($dataCount = mysqli_fetch_assoc($count)){
            echo "<tr>";
            echo "<td>".$i++."</td>";
            echo "<td>".$dataHospital['nama_rs']."</td>";
            echo "<td>";
            if($dataCount['temp']!=0){
                echo "Yes";
            }else{
